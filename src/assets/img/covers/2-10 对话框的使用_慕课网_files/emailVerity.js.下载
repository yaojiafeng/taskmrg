		  ...
		  <div class="rl-modal-body phoneVerityBox">\
		    <form id="signup-form">\
				...
				<div class="rlf-group clearfix finished_wrap">\
			        ...
			        <a href="/user/phonevalidate/"  target="_blank" class="moco-btn moco-btn-normal" style="padding:12px 35px;">其它验证方式</a>\
			    	<a href="/about/faq?t=7&id=6" target="_blank" class="cantGot  js-resendMail" style="  position: relative;top: 10px; display:block">收不到邮件怎么办</a>\
			    </div>\
		    </form>\
		  </div>\
		</div>'