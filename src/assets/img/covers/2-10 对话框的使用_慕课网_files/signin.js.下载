	var signinTpl ='<div id="signin" class="rl-modal">\
				...
				<div class="l-left-wrap l">\
					<form id="signup-form" autocomplete="off">\
						...
						<div class="rlf-group pr">\
							...
							<p class="rlf-tip-wrap errorHint color-red" data-error-hint="请输入正确的手机号或邮箱"></p>\
						</div>\
						<div class="rlf-group  pr">';
                        /*
                        ...
                        */
						...
						<div class="rlf-group clearfix form-control js-verify-row">\
						    ...
						    <a href="javascript:void(0)" hidefocus="true" class="sz-refresh js-verify-refresh"></a>\
						...
						<div class="rlf-group rlf-appendix form-control  clearfix">\
							...
							<a href="http://www.imooc.com/user/newforgot" class="rlf-forget r" target="_blank" hidefocus="true">忘记密码 </a>\
						</div>\
		  ...
		  <div class="rl-model-footer">\
			<div class="pop-login-sns clearfix">\
				...
				<a href="javascript:void(0)" hidefocus="true" data-login-sns="/passport/user/tplogin?tp=weibo" class="pop-sns-weibo r mr60"><i class="sz-weibo-y"></i></a>\
				<a href="javascript:void(0)" hidefocus="true" data-login-sns="/passport/user/tplogin?tp=weixin" class="pop-sns-weixin r"><i class="sz-weixin-y"></i></a>\
				<a href="javascript:void(0)" hidefocus="true" data-login-sns="/passport/user/tplogin?tp=qq" class="pop-sns-qq r"><i class="sz-qq-y"></i></a>\
			</div>\
